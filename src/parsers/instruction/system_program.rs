...
fn parse_transfer_instruction(
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![ParsedField::new("lamports", IdlValue::U64(lamports))].into(),
...
fn parse_create_account_instruction(
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![
                ParsedField::new("lamports", IdlValue::U64(lamports)),
                ParsedField::new("space", IdlValue::U64(space)),
                ParsedField::new("owner", IdlValue::Pubkey(owner)),
            ]
            .into(),
...
fn parse_assign_instruction(
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![ParsedField::new("owner", IdlValue::Pubkey(owner))].into(),
...
fn parse_create_account_with_seed_instruction(
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![
                ParsedField::new("base", IdlValue::Pubkey(base)),
...
fn parse_initialize_nonce_account_instruction(
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![ParsedField::new("authorized", IdlValue::Pubkey(authorized))].into(),
            account_names: vec![
                "nonce_account".to_string(),
                "recent_blockhashes_sysvar".to_string(),
                "rent_sysvar".to_string(),
...
fn parse_authorize_nonce_account_instruction(
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![ParsedField::new("new_authorized", IdlValue::Pubkey(authorized))].into(),
...
fn parse_allocate_instruction(
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![ParsedField::new("space", IdlValue::U64(space))].into(),
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![
                ...
                ParsedField::new("from_owner", IdlValue::Pubkey(from_owner)),
            ]
            .into(),
            account_names: vec![
                "funding_account".to_string(),
