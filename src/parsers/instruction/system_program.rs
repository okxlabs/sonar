    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![
                ...
                ParsedField::pubkey("owner", owner),
            ]
            .into(),
...
fn parse_assign_instruction(
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![ParsedField::pubkey("owner", owner)].into(),
...
fn parse_initialize_nonce_account_instruction(
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![ParsedField::pubkey("authorized", authorized)].into(),
            account_names: vec![
                "nonce_account".to_string(),
                "recent_blockhashes_sysvar".to_string(),
                "rent_sysvar".to_string(),
...
fn parse_authorize_nonce_account_instruction(
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![ParsedField::pubkey("new_authorized", authorized)].into(),
    ...
    binary_reader::try_parse(data, |reader| {
        ...
        Ok(ParsedInstruction {
            ...
            fields: vec![
                ...
                ParsedField::pubkey("from_owner", from_owner),
            ]
            .into(),
            account_names: vec![
                "funding_account".to_string(),
